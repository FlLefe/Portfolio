...
function Technos() {
  ...
  return (
    <div name={t('global.Technos.name')} className='bg-gradient-to-b from-slate-800 via-slate-900 to-slate-950 w-full sm:h-screen px-12 pt-20'>
        <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full text-white'>
            <div>
                <h2 className='text-4xl font-bold border-b-4 border-gray-500 p-2 inline'>Experience</h2>
                <p className='py-6'>{t('global.Technos.p')}</p>
            </div>
